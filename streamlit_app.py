...
if menu == "Home":
    ...
    st.info(
        "Machine Learning KNN untuk klasifikasi penyakit hati"
    )

    st.markdown("""
    ### 📌 Fitur Aplikasi

    - Prediksi penyakit hati menggunakan KNN
...
# ==========================================
    ...
    st.warning("Semua input wajib lebih besar dari 0")
...
# ==========================================
    ...
    st.success(
        "Menjaga hati berarti menjaga kesehatan tubuh secara keseluruhan."
    )
    ...
    df_info = pd.DataFrame({
        ...
        "Fungsi": [
            ...
            "Protein untuk imun dan tekanan darah",
            "Protein utama yang diproduksi hati"
        ],
        "Interpretasi": [
            "Naik → gangguan hati",
            "Naik → sumbatan empedu",
            "Naik → kerusakan sel hati",
            "Naik → gangguan hati atau otot",
